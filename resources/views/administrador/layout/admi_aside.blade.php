        ...
        <div class="lista_1">
            <div class="item_lista">
                <a href="{{ route('administrador') }}"
                    class="title_lista{{ request()->is('admi/administrador*') ? ' active_sect' : '' }} d-block"><span><i
                            class="fa-solid fa-house"></i>Inicio</span></a>
            </div>
            <div class="item_lista">
                <div
                    class="title_lista d-flex align-items-center justify-content-between{{ request()->is('admi/usuarios*') || request()->is('admi/roles*') ? ' active_sect' : '' }}">
                    <span><i class="fa-solid fa-user"></i>Usuarios</span> <i class="fa-light fa-angle-down"></i>
                </div>
                <div class="cont_lista">
                    <ul class="lista_2">
                        <li class="item_2"><a href="{{ route('usuarios') }}" class="link_2">Usuarios</a></li>
                        <li class="item_2"><a href="{{ route('roles') }}" class="link_2">Roles</a></li>
                        <li class="item_2"><a href="{{ route('tiendas') }}" class="link_2">Tiendas</a></li>
                    </ul>
                </div>
            </div>
            <div class="item_lista">

    ...
    <div class="cont_grid">
        <div class="grid_2">
            <div class="item_grid_2 box-light">
                <div class="img_grid">
                    <img src="<?php echo e(asset('img/producto.jpg')); ?>" alt="">
                </div>
                <div class="info_prod">
...
<?php echo $__env->make('tienda.layout.store', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Proyectos\qori\resources\views/tienda/pages/carrito.blade.php ENDPATH**/ ?>
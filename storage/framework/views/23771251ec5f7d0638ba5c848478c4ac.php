        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body form_add">
                    ...
                    <form action="<?php echo e(route('roles.create')); ?>" class="form_all" id="crearRolForm">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('administrador.layout.admi_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Proyectos\qori\resources\views/administrador/pages/roles.blade.php ENDPATH**/ ?>
<aside class="aside box-light scrool_1 shadow-1">
    ...
    <div class="aside_body">
        <p class="txt-point">Hola: <?php echo e(Auth::user()->nombre); ?> <?php echo e(Auth::user()->apellidos); ?></p>
        <p>Menú del usuario</p>
        <div class="lista_1">
            <div class="item_lista">
                <a href="<?php echo e(route('home')); ?>"
                    class="title_lista d-block<?php echo e(request()->is('user/home*') ? ' active_sect' : ''); ?>"><span><i
                            class="fa-solid fa-house"></i>Inicio</span></a>
            </div>
            <div class="item_lista">
                <div
                    class="title_lista<?php echo e(request()->is('user/create_store*') ? ' active_sect' : ''); ?> d-flex align-items-center justify-content-between">
                    <span><i class="fa-solid fa-gear"></i>Tienda</span> <i class="fa-light fa-angle-down"></i>
                </div>
                <div class="cont_lista ">
                    <ul class="lista_2">
                        <li class="item_2"><a href="<?php echo e(route('create_store')); ?>" class="link_2">Crear tienda</a>
                        </li>

                        <li class="item_2"><a href="<?php echo e(route('tienda')); ?>" class="link_2">Tienda 1</a></li>
...
<?php /**PATH C:\xampp\htdocs\Proyectos\qori\resources\views/usuarios/layout/user_aside.blade.php ENDPATH**/ ?>